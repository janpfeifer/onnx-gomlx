...
func (Version) Descriptor() protoreflect.EnumDescriptor {
	return file_onnx_ml_proto_enumTypes[0].Descriptor()
}

func (Version) Type() protoreflect.EnumType {
	return &file_onnx_ml_proto_enumTypes[0]
}
...
func (Version) EnumDescriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{0}
}
...
func (OperatorStatus) Descriptor() protoreflect.EnumDescriptor {
	return file_onnx_ml_proto_enumTypes[1].Descriptor()
}

func (OperatorStatus) Type() protoreflect.EnumType {
	return &file_onnx_ml_proto_enumTypes[1]
}
...
func (OperatorStatus) EnumDescriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{1}
}
...
func (AttributeProto_AttributeType) Descriptor() protoreflect.EnumDescriptor {
	return file_onnx_ml_proto_enumTypes[2].Descriptor()
}

func (AttributeProto_AttributeType) Type() protoreflect.EnumType {
	return &file_onnx_ml_proto_enumTypes[2]
}
...
func (AttributeProto_AttributeType) EnumDescriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{0, 0}
}
...
func (TensorProto_DataType) Descriptor() protoreflect.EnumDescriptor {
	return file_onnx_ml_proto_enumTypes[3].Descriptor()
}

func (TensorProto_DataType) Type() protoreflect.EnumType {
	return &file_onnx_ml_proto_enumTypes[3]
}
...
func (TensorProto_DataType) EnumDescriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{8, 0}
}
...
func (TensorProto_DataLocation) Descriptor() protoreflect.EnumDescriptor {
	return file_onnx_ml_proto_enumTypes[4].Descriptor()
}

func (TensorProto_DataLocation) Type() protoreflect.EnumType {
	return &file_onnx_ml_proto_enumTypes[4]
}
...
func (TensorProto_DataLocation) EnumDescriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{8, 1}
}
...
func (x *AttributeProto) Reset() {
	*x = AttributeProto{}
	mi := &file_onnx_ml_proto_msgTypes[0]
...
func (x *ValueInfoProto) Reset() {
	*x = ValueInfoProto{}
	mi := &file_onnx_ml_proto_msgTypes[1]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *NodeProto) Reset() {
	*x = NodeProto{}
	mi := &file_onnx_ml_proto_msgTypes[2]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*NodeProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{2}
}
...
func (x *TrainingInfoProto) Reset() {
	*x = TrainingInfoProto{}
	mi := &file_onnx_ml_proto_msgTypes[3]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TrainingInfoProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{3}
}
...
func (x *ModelProto) Reset() {
	*x = ModelProto{}
	mi := &file_onnx_ml_proto_msgTypes[4]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*ModelProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{4}
}
...
func (x *StringStringEntryProto) Reset() {
	*x = StringStringEntryProto{}
	mi := &file_onnx_ml_proto_msgTypes[5]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*StringStringEntryProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{5}
}
...
func (x *TensorAnnotation) Reset() {
	*x = TensorAnnotation{}
	mi := &file_onnx_ml_proto_msgTypes[6]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TensorAnnotation) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{6}
}
...
func (x *GraphProto) Reset() {
	*x = GraphProto{}
	mi := &file_onnx_ml_proto_msgTypes[7]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*GraphProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{7}
}
...
type TensorProto struct {
	...
	DataLocation TensorProto_DataLocation `protobuf:"varint,14,opt,name=data_location,json=dataLocation,proto3,enum=protos.TensorProto_DataLocation" json:"data_location,omitempty"`
	// For double
...
func (x *TensorProto) Reset() {
	*x = TensorProto{}
	mi := &file_onnx_ml_proto_msgTypes[8]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TensorProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{8}
}
...
func (x *SparseTensorProto) Reset() {
	*x = SparseTensorProto{}
	mi := &file_onnx_ml_proto_msgTypes[9]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*SparseTensorProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{9}
}
...
func (x *TensorShapeProto) Reset() {
	*x = TensorShapeProto{}
	mi := &file_onnx_ml_proto_msgTypes[10]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TensorShapeProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{10}
}
...
func (x *TypeProto) Reset() {
	*x = TypeProto{}
	mi := &file_onnx_ml_proto_msgTypes[11]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{11}
}
...
func (x *TypeProto) GetOpaqueType() *TypeProto_Opaque {
	if x, ok := x.GetValue().(*TypeProto_OpaqueType); ok {
		return x.OpaqueType
	}
	return nil
}
...
func (*TypeProto_OpaqueType) isTypeProto_Value() {}
...
func (x *OperatorSetIdProto) Reset() {
	*x = OperatorSetIdProto{}
	mi := &file_onnx_ml_proto_msgTypes[12]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*OperatorSetIdProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{12}
}
...
func (x *FunctionProto) Reset() {
	*x = FunctionProto{}
	mi := &file_onnx_ml_proto_msgTypes[13]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*FunctionProto) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{13}
}
...
func (x *TensorProto_Segment) Reset() {
	*x = TensorProto_Segment{}
	mi := &file_onnx_ml_proto_msgTypes[14]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (x *TensorShapeProto_Dimension) Reset() {
	*x = TensorShapeProto_Dimension{}
	mi := &file_onnx_ml_proto_msgTypes[15]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TensorShapeProto_Dimension) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{10, 0}
}
...
func (x *TypeProto_Tensor) Reset() {
	*x = TypeProto_Tensor{}
	mi := &file_onnx_ml_proto_msgTypes[16]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Tensor) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{11, 0}
}
...
func (x *TypeProto_Sequence) Reset() {
	*x = TypeProto_Sequence{}
	mi := &file_onnx_ml_proto_msgTypes[17]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Sequence) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{11, 1}
}
...
func (x *TypeProto_Map) Reset() {
	*x = TypeProto_Map{}
	mi := &file_onnx_ml_proto_msgTypes[18]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Map) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{11, 2}
}
...
func (x *TypeProto_Optional) Reset() {
	*x = TypeProto_Optional{}
	mi := &file_onnx_ml_proto_msgTypes[19]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Optional) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{11, 3}
}
...
func (x *TypeProto_SparseTensor) Reset() {
	*x = TypeProto_SparseTensor{}
	mi := &file_onnx_ml_proto_msgTypes[20]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_SparseTensor) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{11, 4}
}
...
func (x *TypeProto_Opaque) Reset() {
	*x = TypeProto_Opaque{}
	mi := &file_onnx_ml_proto_msgTypes[21]
	ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
	ms.StoreMessageInfo(mi)
}
...
func (*TypeProto_Opaque) Descriptor() ([]byte, []int) {
	return file_onnx_ml_proto_rawDescGZIP(), []int{11, 5}
}
...
var file_onnx_ml_proto_rawDesc = []byte{
	0x0a, 0x0d, 0x6f, 0x6e, 0x6e, 0x78, 0x2d, 0x6d, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12,
	0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x22, 0xf5, 0x06, 0x0a, 0x0e, 0x41, 0x74, 0x74, 0x72,
	...
	,
	...
	,
	...
	,
	...
	0x94, 0x01, 0x0a, 0x10, 0x54, 0x65, 0x6e, 0x73, 0x6f, 0x72, 0x41, 0x6e, 0x6e, 0x6f, 0x74, 0x61,
	...
	,
	...
	,
	...
	,
	...
	,
	...
	0x70, 0x73, 0x1a, 0x31, 0x0a, 0x07, 0x53, 0x65, 0x67, 0x6d, 0x65, 0x6e, 0x74, 0x12, 0x14, 0x0a,
	...
	0x52, 0x03, 0x65, 0x6e, 0x64, 0x22, 0xc9, 0x02, 0x0a, 0x08, 0x44, 0x61, 0x74, 0x61, 0x54, 0x79,
	...
	,
	...
	0x6f, 0x72, 0x54, 0x79, 0x70, 0x65, 0x12, 0x3b, 0x0a, 0x0b, 0x6f, 0x70, 0x61, 0x71, 0x75, 0x65,
	0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x07, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70, 0x72,
	0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x4f,
	0x70, 0x61, 0x71, 0x75, 0x65, 0x48, 0x00, 0x52, 0x0a, 0x6f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x54,
	...
	,
	...
	0x79, 0x70, 0x65, 0x12, 0x2e, 0x0a, 0x05, 0x73, 0x68, 0x61, 0x70, 0x65, 0x18, 0x02, 0x20, 0x01,
	0x28, 0x0b, 0x32, 0x18, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x73, 0x2e, 0x54, 0x65, 0x6e, 0x73,
	0x6f, 0x72, 0x53, 0x68, 0x61, 0x70, 0x65, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x52, 0x05, 0x73, 0x68,
	0x61, 0x70, 0x65, 0x1a, 0x34, 0x0a, 0x06, 0x4f, 0x70, 0x61, 0x71, 0x75, 0x65, 0x12, 0x16, 0x0a,
	...
	,
	...
	0x69, 0x6e, 0x67, 0x12, 0x3d, 0x0a, 0x0c, 0x6f, 0x70, 0x73, 0x65, 0x74, 0x5f, 0x69, 0x6d, 0x70,
	0x6f, 0x72, 0x74, 0x18, 0x09, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1a, 0x2e, 0x70, 0x72, 0x6f, 0x74,
	0x6f, 0x73, 0x2e, 0x4f, 0x70, 0x65, 0x72, 0x61, 0x74, 0x6f, 0x72, 0x53, 0x65, 0x74, 0x49, 0x64,
	0x50, 0x72, 0x6f, 0x74, 0x6f, 0x52, 0x0b, 0x6f, 0x70, 0x73, 0x65, 0x74, 0x49, 0x6d, 0x70, 0x6f,
	...
	,
}

var (
	file_onnx_ml_proto_rawDescOnce sync.Once
	file_onnx_ml_proto_rawDescData = file_onnx_ml_proto_rawDesc
)

func file_onnx_ml_proto_rawDescGZIP() []byte {
	file_onnx_ml_proto_rawDescOnce.Do(func() {
		file_onnx_ml_proto_rawDescData = protoimpl.X.CompressGZIP(file_onnx_ml_proto_rawDescData)
	})
	return file_onnx_ml_proto_rawDescData
}

var file_onnx_ml_proto_enumTypes = make([]protoimpl.EnumInfo, 5)
var file_onnx_ml_proto_msgTypes = make([]protoimpl.MessageInfo, 22)
var file_onnx_ml_proto_goTypes = []any{
	(Version)(0),                       // 0: protos.Version
	(OperatorStatus)(0),                // 1: protos.OperatorStatus
	(AttributeProto_AttributeType)(0),  // 2: protos.AttributeProto.AttributeType
	(TensorProto_DataType)(0),          // 3: protos.TensorProto.DataType
	(TensorProto_DataLocation)(0),      // 4: protos.TensorProto.DataLocation
	(*AttributeProto)(nil),             // 5: protos.AttributeProto
	(*ValueInfoProto)(nil),             // 6: protos.ValueInfoProto
	(*NodeProto)(nil),                  // 7: protos.NodeProto
	(*TrainingInfoProto)(nil),          // 8: protos.TrainingInfoProto
	(*ModelProto)(nil),                 // 9: protos.ModelProto
	(*StringStringEntryProto)(nil),     // 10: protos.StringStringEntryProto
	(*TensorAnnotation)(nil),           // 11: protos.TensorAnnotation
	(*GraphProto)(nil),                 // 12: protos.GraphProto
	(*TensorProto)(nil),                // 13: protos.TensorProto
	(*SparseTensorProto)(nil),          // 14: protos.SparseTensorProto
	(*TensorShapeProto)(nil),           // 15: protos.TensorShapeProto
	(*TypeProto)(nil),                  // 16: protos.TypeProto
	(*OperatorSetIdProto)(nil),         // 17: protos.OperatorSetIdProto
	(*FunctionProto)(nil),              // 18: protos.FunctionProto
	(*TensorProto_Segment)(nil),        // 19: protos.TensorProto.Segment
	(*TensorShapeProto_Dimension)(nil), // 20: protos.TensorShapeProto.Dimension
	(*TypeProto_Tensor)(nil),           // 21: protos.TypeProto.Tensor
	(*TypeProto_Sequence)(nil),         // 22: protos.TypeProto.Sequence
	(*TypeProto_Map)(nil),              // 23: protos.TypeProto.Map
	(*TypeProto_Optional)(nil),         // 24: protos.TypeProto.Optional
	(*TypeProto_SparseTensor)(nil),     // 25: protos.TypeProto.SparseTensor
	(*TypeProto_Opaque)(nil),           // 26: protos.TypeProto.Opaque
}
var file_onnx_ml_proto_depIdxs = []int32{
	2,  // 0: protos.AttributeProto.type:type_name -> protos.AttributeProto.AttributeType
	13, // 1: protos.AttributeProto.t:type_name -> protos.TensorProto
	12, // 2: protos.AttributeProto.g:type_name -> protos.GraphProto
	14, // 3: protos.AttributeProto.sparse_tensor:type_name -> protos.SparseTensorProto
	16, // 4: protos.AttributeProto.tp:type_name -> protos.TypeProto
	13, // 5: protos.AttributeProto.tensors:type_name -> protos.TensorProto
	12, // 6: protos.AttributeProto.graphs:type_name -> protos.GraphProto
	14, // 7: protos.AttributeProto.sparse_tensors:type_name -> protos.SparseTensorProto
	16, // 8: protos.AttributeProto.type_protos:type_name -> protos.TypeProto
	16, // 9: protos.ValueInfoProto.type:type_name -> protos.TypeProto
	10, // 10: protos.ValueInfoProto.metadata_props:type_name -> protos.StringStringEntryProto
	5,  // 11: protos.NodeProto.attribute:type_name -> protos.AttributeProto
	10, // 12: protos.NodeProto.metadata_props:type_name -> protos.StringStringEntryProto
	12, // 13: protos.TrainingInfoProto.initialization:type_name -> protos.GraphProto
	12, // 14: protos.TrainingInfoProto.algorithm:type_name -> protos.GraphProto
	10, // 15: protos.TrainingInfoProto.initialization_binding:type_name -> protos.StringStringEntryProto
	10, // 16: protos.TrainingInfoProto.update_binding:type_name -> protos.StringStringEntryProto
	17, // 17: protos.ModelProto.opset_import:type_name -> protos.OperatorSetIdProto
	12, // 18: protos.ModelProto.graph:type_name -> protos.GraphProto
	10, // 19: protos.ModelProto.metadata_props:type_name -> protos.StringStringEntryProto
	8,  // 20: protos.ModelProto.training_info:type_name -> protos.TrainingInfoProto
	18, // 21: protos.ModelProto.functions:type_name -> protos.FunctionProto
	10, // 22: protos.TensorAnnotation.quant_parameter_tensor_names:type_name -> protos.StringStringEntryProto
	7,  // 23: protos.GraphProto.node:type_name -> protos.NodeProto
	13, // 24: protos.GraphProto.initializer:type_name -> protos.TensorProto
	14, // 25: protos.GraphProto.sparse_initializer:type_name -> protos.SparseTensorProto
	6,  // 26: protos.GraphProto.input:type_name -> protos.ValueInfoProto
	6,  // 27: protos.GraphProto.output:type_name -> protos.ValueInfoProto
	6,  // 28: protos.GraphProto.value_info:type_name -> protos.ValueInfoProto
	11, // 29: protos.GraphProto.quantization_annotation:type_name -> protos.TensorAnnotation
	10, // 30: protos.GraphProto.metadata_props:type_name -> protos.StringStringEntryProto
	19, // 31: protos.TensorProto.segment:type_name -> protos.TensorProto.Segment
	10, // 32: protos.TensorProto.external_data:type_name -> protos.StringStringEntryProto
	4,  // 33: protos.TensorProto.data_location:type_name -> protos.TensorProto.DataLocation
	10, // 34: protos.TensorProto.metadata_props:type_name -> protos.StringStringEntryProto
	13, // 35: protos.SparseTensorProto.values:type_name -> protos.TensorProto
	13, // 36: protos.SparseTensorProto.indices:type_name -> protos.TensorProto
	20, // 37: protos.TensorShapeProto.dim:type_name -> protos.TensorShapeProto.Dimension
	21, // 38: protos.TypeProto.tensor_type:type_name -> protos.TypeProto.Tensor
	22, // 39: protos.TypeProto.sequence_type:type_name -> protos.TypeProto.Sequence
	23, // 40: protos.TypeProto.map_type:type_name -> protos.TypeProto.Map
	24, // 41: protos.TypeProto.optional_type:type_name -> protos.TypeProto.Optional
	25, // 42: protos.TypeProto.sparse_tensor_type:type_name -> protos.TypeProto.SparseTensor
	26, // 43: protos.TypeProto.opaque_type:type_name -> protos.TypeProto.Opaque
	5,  // 44: protos.FunctionProto.attribute_proto:type_name -> protos.AttributeProto
	7,  // 45: protos.FunctionProto.node:type_name -> protos.NodeProto
	17, // 46: protos.FunctionProto.opset_import:type_name -> protos.OperatorSetIdProto
	6,  // 47: protos.FunctionProto.value_info:type_name -> protos.ValueInfoProto
	10, // 48: protos.FunctionProto.metadata_props:type_name -> protos.StringStringEntryProto
	15, // 49: protos.TypeProto.Tensor.shape:type_name -> protos.TensorShapeProto
	16, // 50: protos.TypeProto.Sequence.elem_type:type_name -> protos.TypeProto
	16, // 51: protos.TypeProto.Map.value_type:type_name -> protos.TypeProto
	16, // 52: protos.TypeProto.Optional.elem_type:type_name -> protos.TypeProto
	15, // 53: protos.TypeProto.SparseTensor.shape:type_name -> protos.TensorShapeProto
...
func init() { file_onnx_ml_proto_init() }
func file_onnx_ml_proto_init() {
	if File_onnx_ml_proto != nil {
		return
	}
	file_onnx_ml_proto_msgTypes[11].OneofWrappers = []any{
		...
		(*TypeProto_OpaqueType)(nil),
	}
	file_onnx_ml_proto_msgTypes[15].OneofWrappers = []any{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_onnx_ml_proto_rawDesc,
			NumEnums:      5,
			NumMessages:   22,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_onnx_ml_proto_goTypes,
		DependencyIndexes: file_onnx_ml_proto_depIdxs,
		EnumInfos:         file_onnx_ml_proto_enumTypes,
		MessageInfos:      file_onnx_ml_proto_msgTypes,
	}.Build()
	File_onnx_ml_proto = out.File
	file_onnx_ml_proto_rawDesc = nil
	file_onnx_ml_proto_goTypes = nil
	file_onnx_ml_proto_depIdxs = nil
}
